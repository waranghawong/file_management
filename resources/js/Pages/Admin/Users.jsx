...
export default function Dashboard({ auth, users }) {
    ...
    return (
        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-8xl mx-auto sm:px-6 lg:px-8"> <Link className="ml-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" href={route("users.new")}></Link> <br /><br />
